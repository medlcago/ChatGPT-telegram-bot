...
from bot.keyboards.callbacks import SendMessageAction, SendMessage, ReplyUserAction, ReplyUser, Model
...
def get_model_list_button(models: list, add_close_button: bool = False) -> InlineKeyboardMarkup:
    builder = InlineKeyboardBuilder()
    for model in models:
